# DESCRIPTION:
# 
# More barebones version of the picture.py eyelink example
# 
...
def run_trial(trial_pars, trial_index):
    ...
    img = visual.ImageStim(win,
        image=os.path.join("images",pic))       # default size is size of im file
    ...
    while not get_keypress:
        ...
        if core.getTime() - img_onset_time >= 10.0:
